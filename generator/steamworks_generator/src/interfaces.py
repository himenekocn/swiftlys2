...
def main(parser):
    try:
        os.makedirs("../../managed/src/SwiftlyS2.Generated/SteamAPI/")
    except OSError:
        pass
    ...
    with open("../../managed/src/SwiftlyS2.Generated/SteamAPI/NativeMethods.cs", "wb") as out:
...
def parse(f):
    ...
    if g_Output:
        with open('../../managed/src/SwiftlyS2.Generated/SteamAPI/' + os.path.splitext(f.name)[0] + '.cs', 'wb') as out:
            ...
            out.write(bytes(HEADER, "utf-8"))
            out.write(bytes("namespace SwiftlyS2.Shared.SteamAPI {\n", "utf-8"))
